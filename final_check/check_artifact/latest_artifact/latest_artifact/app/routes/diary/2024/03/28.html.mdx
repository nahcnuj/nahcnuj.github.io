...
[『Theorem Proving in Lean 4』](./23.html)を読み終え、続けてLean 4での関数型プログラミングを学ぶために[『Functional Programming in Lean 4』](https://leanprover.github.io/functional_programming_in_lean/title.html)を読んでいます。
