---
title: Node.jsの新しいバージョンマネージャーfnm
...
## Node.jsの新しいバージョンマネージャーfnm

<div style="min-height:600px;display:flex;align-items:center;justify-content:center">
  <blockquote class="twitter-tweet">
    <p lang="en" dir="ltr">
      Is <a href="https://twitter.com/hashtag/fnm?src=hash&amp;ref_src=twsrc%5Etfw">#fnm</a> the new standard?
...
公式の方法としては他に従来の`nvm`やDockerイメージの利用が選択できるようですが、`nvm`はグレーアウトして選択できませんでした。
