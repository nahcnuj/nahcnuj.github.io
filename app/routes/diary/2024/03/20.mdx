...
[HonoXのバージョン0.1.9](https://github.com/honojs/honox/releases/tag/v0.1.9)にて[`createApp`関数に`trailingSlash`オプションが追加されていました](https://github.com/honojs/honox#trailing-slash)。
